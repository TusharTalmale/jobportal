...
part of 'job_application_api_service.dart';
...
class _JobApplicationApiService implements JobApplicationApiService {
  ...
  Future<List<JobApplication>> getAllApplications() async {
    ...
    final _options = _setStreamType<List<JobApplication>>(
    ...
    late List<JobApplication> _value;
    try {
      _value =
          _result.data!
              .map(
                (dynamic i) =>
                    JobApplication.fromJson(i as Map<String, dynamic>),
              )
              .toList();
    } on Object catch (e, s) {
  ...
  @override
  Future<JobApplication> getApplicationById(int id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<JobApplication>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/applyJob/${id}',
    ...
    late JobApplication _value;
    try {
      _value = JobApplication.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<JobApplicationComment> addComment(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(request.toJson());
    final _options = _setStreamType<JobApplicationComment>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/applyJob/${id}/comment',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late JobApplicationComment _value;
    try {
      _value = JobApplicationComment.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
