...
class _PostApiService implements PostApiService {
  ...
  @override
  Future<CompanyPost> getPostById(int postId) async {
    final _extra = <String, dynamic>{};
  ...
  @override
  Future<Comment> addComment(int postId, Map<String, dynamic> body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<void> deleteComment(int commentId, Map<String, int> body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
